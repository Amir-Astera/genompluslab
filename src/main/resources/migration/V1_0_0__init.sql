...
CREATE TABLE IF NOT EXISTS ANALYSIS (
        ...
        MATERIAL_KEY_ID VARCHAR (255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS ORDERS (
   ...
   CREATED_AT TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
   UPDATED_AT TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
   CONSTRAINT UC_ORDER_ID UNIQUE (ID)
);

CREATE TABLE IF NOT EXISTS ORDER_ANALYSIS (
    ID VARCHAR (255) NOT NULL PRIMARY KEY,
    ORDER_ID VARCHAR (225) NOT NULL,
    ANALYSIS_ID VARCHAR (225) NOT NULL,
    PRICE VARCHAR (225) NOT NULL,
    STATUS VARCHAR (225) NOT NULL,
    VERSION BIGINT DEFAULT 1,
    CREATED_AT TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    UPDATED_AT TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT UC_ORDER_ANALYSIS_ID UNIQUE (ID)
);

alter table ANALYSIS add column MATERIAL_KEY_ID VARCHAR(255) NOT NULL default '';
